                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-text-secondary">
                      Browse and hire talent for your brand
                    </p>
                  </div>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-text-secondary text-sm">Saved Creators</p>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-text-secondary text-sm">Total Connections</p>
