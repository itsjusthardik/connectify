...
export const GenericDashboard = () => {
  ...
  return (
    <ProtectedRoute>
      <RoleProtectedRoute allowedRoles={['Other']}>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-text-secondary">
                      {user?.customRole || 'Connect with creators and talent'}
                    </p>
                  </div>
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-text-secondary text-sm">My Connections</p>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Briefcase size={40} className="text-cyan/30" />
                  </div>
                </motion.div>
              </motion.div>
            </div>
